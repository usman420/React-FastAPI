...
This is the FARM Stack , I have build a todo app with fastapi ,react and mangodb
----------------------------------------------------------
<br/>
FARM stands for FastAPI - React - MongoDB.

I have built my app using FASTAPI for the backend server, React for the frontend client, 
